...
unit module LibXML::Raw::Gen::DOCBparser;
...
our sub docbCreateFileParserCtxt(Str $filename, Str $encoding --> docbParserCtxt) is native(XML2) is export {*}
our sub docbCreatePushParserCtxt(docbSAXHandler $sax, Pointer $user_data, Str $chunk, int32 $size, Str $filename, xmlCharEncoding $enc --> docbParserCtxt) is native(XML2) is export {*}
