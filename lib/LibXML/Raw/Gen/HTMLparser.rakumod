...
unit module LibXML::Raw::Gen::HTMLparser;
...
our sub htmlCreateMemoryParserCtxt(Str $buffer, int32 $size --> htmlParserCtxt) is native(XML2) is export {*}
our sub htmlCreatePushParserCtxt(htmlSAXHandler $sax, Pointer $user_data, Str $chunk, int32 $size, Str $filename, xmlCharEncoding $enc --> htmlParserCtxt) is native(XML2) is export {*}
...
our sub htmlNewParserCtxt( --> htmlParserCtxt) is native(XML2) is export {*}
our sub htmlNodeStatus(const htmlNode $node, int32 $legacy --> htmlStatus) is native(XML2) is export {*}
