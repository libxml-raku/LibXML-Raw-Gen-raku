...
unit module LibXML::Raw::Gen::xmlerror;
# error handling:
...
class xmlError is repr('CStruct') {
    ...
    our sub xmlCtxtGetLastError(Pointer $ctx --> xmlError) is native(XML2) is export {*}
    our sub xmlGetLastError( --> xmlError) is native(XML2) is export {*}

    method xmlCopyError(xmlError $to --> int32) is native(XML2) {*}
    method xmlResetError() is native(XML2) {*}
}
